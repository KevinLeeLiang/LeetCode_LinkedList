...
#ifndef L146_LRUCACHE_CPP_L355_TWITTER_H
#define L146_LRUCACHE_CPP_L355_TWITTER_H
...
class L355_Twitter : public LeetcodeLinkedList {
public:
    L355_Twitter() {}
    void test();
};
...
#endif //L146_LRUCACHE_CPP_L355_TWITTER_H
