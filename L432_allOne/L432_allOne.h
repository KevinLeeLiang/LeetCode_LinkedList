...
#ifndef L146_LRUCACHE_CPP_L432_ALLONE_H
#define L146_LRUCACHE_CPP_L432_ALLONE_H
...
class L432_allOne : public LeetcodeLinkedList {
public:
    L432_allOne() {}
    void test();
};
...
#endif //L146_LRUCACHE_CPP_L432_ALLONE_H
